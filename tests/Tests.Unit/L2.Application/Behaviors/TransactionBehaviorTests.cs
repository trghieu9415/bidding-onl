...
public class TransactionBehaviorTests {
  ...
  [Fact]
  public async Task Handle_Should_CommitTransactionAndDispatchEvents_WhenNextSucceeds() {
    // Arrange
  ...
  [Fact]
  public async Task Handle_Should_RollbackTransaction_WhenNextThrowsException() {
    // Arrange
    var request = new TestTransactionRequest();
  ...
  [Fact]
  public async Task Handle_Should_NotCatchException_WhenBeginTransactionThrows() {
    // Arrange
    var request = new TestTransactionRequest();
    var expectedException = new InvalidOperationException("Begin error");
