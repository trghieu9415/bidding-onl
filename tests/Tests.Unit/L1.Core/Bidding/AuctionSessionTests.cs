...
public class AuctionSessionTests {
  ...
  public void SetTimeFrame_WhenSessionIsLive_ThrowsDomainException() {
    ...
    var exception = Assert.Throws<DomainException>(() => session.SetTimeFrame(DateTime.UtcNow.AddHours(3), DateTime.UtcNow.AddHours(4)));
  ...
  public void SetTimeFrame_WhenEndTimeIsInPast_ThrowsDomainException() {
    ...
    var exception = Assert.Throws<DomainException>(() => session.SetTimeFrame(DateTime.UtcNow.AddHours(-2), DateTime.UtcNow.AddHours(-1)));
